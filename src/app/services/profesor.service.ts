...
export class ProfesorService {
  ...
  getMethod():Observable<any> {
    return this.http.get(`${this.api}profesor/profesor1/`,httpOptions2);
  }
  postMethod(params: string):Observable<any> {
    // console.log(params);
    // console.log('get token: '+localStorage.getItem('token'));
    return this.http.post(`${this.api}profesor/profesor1/`,params, httpOptions2);
  }

  updateMethod(params: string, id:number):Observable<any>{
    return this.http.put(`${this.api}profesor/profesor1detail/${id}`,params, httpOptions2);
  }

  deletedMethod(id:number):Observable<any>{
    return this.http.delete(`${this.api}profesor/profesor1detail/${id}`,httpOptions2);
  }
}
